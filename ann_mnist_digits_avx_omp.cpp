...
void MatrixVectorMultiply_omp(double* Y, const double* X, double *M, int m_rows, int m_cols)
{
...
#ifndef JUST_AVX
// implementation of the matrix-vector multiply function
void MatrixVectorMultiply_avx_omp(double* Y, const double* X, double *M, int m_rows, int m_cols)
{
    int quad_double_vec_size = m_cols / 4;
    int quad_double_leftover = m_cols % 4;
    #pragma omp parallel
...
#else
void MatrixVectorMultiply_avx(double* Y, const double* X, double *M, int m_rows, int m_cols)
{
   __m256d localX;
   __m256d localM;
  int quad_double_vec_size = m_cols / 4;
...
#ifdef JUST_AVX
/*
 * need gcc v4.9 or higher for AVX512 ....
 */
...
#ifdef JUST_OMP
                 MatrixVectorMultiply_omp(netin[i].memptr(), actuation[i].memptr(), layer_weights[i].memptr(), layer_weights[i].n_rows,  layer_weights[i].n_cols);
#else
#ifdef JUST_AVX
                 MatrixVectorMultiply_avx(netin[i].memptr(), actuation[i].memptr(), layer_weights[i].memptr(), layer_weights[i].n_rows,  layer_weights[i].n_cols);
#else
                 MatrixVectorMultiply_avx_omp(netin[i].memptr(), actuation[i].memptr(), layer_weights[i].memptr(), layer_weights[i].n_rows,  layer_weights[i].n_cols);
#endif
#endif
